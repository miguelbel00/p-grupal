...
// import { Table, Button, Modal,Alert,Menu,MenuProps } from 'antd'
...
//             datIndex: 'name',
//             key: 'nameTable',
//             render: (value) => <p>{value.fullName}</p>,
//         },
//         {
//             title: 'Email',
//             datIndex: 'email',
//             key: 'emailTable',
//             render: (value) => <p>{value.email}</p>,
//         },
//         {
//             title: 'Rol',
//             datIndex: 'rol',
//             key: 'rol',
//             render: (value) => {
//                 if (value.isAdmin === true) { return <p>Admin</p> } else { return <p>User</p> }
//             },
//             filters: [
//                 {
//                     text: 'Admin',
